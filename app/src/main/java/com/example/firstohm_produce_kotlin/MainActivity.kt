...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
           ...
           // local_test_layout.visibility= View.VISIBLE
            ...
            btn_testuid.setOnClickListener{
                userBar=edit_testuid.text.toString()
            ...
            btn_editneibei.setOnClickListener{
                btn_editneibei.setBackgroundColor((Color.parseColor("#FFBB86FC")))
                Handler(Looper.getMainLooper()).postDelayed({
                    //dialog 接rootviews
                    Dialogpart(window.decorView.rootView).show(supportFragmentManager, "MyCustomFragment")
                }, 0)
                Handler(Looper.getMainLooper()).postDelayed({
                    btn_editneibei.setBackgroundColor((Color.parseColor("#D6D6D6")))
                }, 200)
            ...
            carmera = saveip.getString("carmera", "0")
            color_direction = saveip.getString("color_direction", "")
            ...
            more_option_btn2.setOnClickListener {
            ...
            btn_update.setOnClickListener{
                if ((shiftName=="早班"  ||shiftName=="辦公室")&&!(cpuInfo.contains("Intel"))){
                    download_apk()
                }
            }
            ...
            savebtn.setOnClickListener{
                try {
                    ...
                    sharedPref.edit().putString("carmera", MainActivity.carmera).commit()
                    ...
                    sharedPref.edit().putString("color_direction", MainActivity.color_direction).commit()
    ...
    public fun login() {
        ...
        try {
            ...
            var jsonString:String?=webapiClient.requestPOST(ip + "PrdMgn/Login?userBar=" + userBar +
                    "&Dept=" + MainActivity.dept + "&facroryNo=" + facrory+
                    "&appVersion=tablet_name："+ table_custom_name+"/"+ table_name_value+"/"+ version, json)
            var jsonStr = JSONObject(jsonString)
    ...
    companion object{
        ...
        var carmera: String = String()
        var name_Edit: String = String()
        ...
        var MID_Edit : String = String()
        var date_Edit : String = String()
        ...
        var speed_value1: String = String()
        var edit_naibeisign: String = String()
        var more_potion_flag: String = String()
        ...
        var cpuInfomation: String = String()
    }
    ...
    fun partfinsh(text: String) {
        val rootView = window.decorView.rootView
        val ui_Helper = co.ubunifu.kotlinhttpsample.Lib.UI_Helper(rootView)
        ui_Helper.mesage("小批修改完成", this@MainActivity)
    }
    fun ui(){
