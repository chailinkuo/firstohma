...
class setting: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        try {
            ...
            }else if(MainActivity.ip=="http://192.168.1.35:1111/firstohmWebApi/"){
                radioButton_35.isChecked=true
            }else{
            ...
            save.setOnClickListener {
                ...
                if(radioButton5.isChecked==true){
                    MainActivity.carmera="1"
                }else{
                    MainActivity.carmera="0"
                }
                ...
                }else if(radioButton_35.isChecked==true){
                    MainActivity.ip="http://172.168.1.35:1111/firstohmWebApi/"
                }else{
